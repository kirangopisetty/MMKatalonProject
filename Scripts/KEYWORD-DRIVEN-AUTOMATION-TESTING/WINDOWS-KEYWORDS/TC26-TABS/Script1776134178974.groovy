...
WebUI.newTab('https://mindmajix.com/corporate-training')

WebUI.newTab('https://mindmajix.com/blog')
...
WebUI.switchToWindowUrl('https://mindmajix.com/blog')
...
WebUI.closeWindowUrl('https://mindmajix.com/blog')

...
WebUI.selectOptionByLabel(findTestObject('CURA-OR/DROPDOWN'), GlobalVariable.varFacility, false)
...
WebUI.setText(findTestObject('CURA-OR/VISIT-DATE'), GlobalVariable.varVisitDate)

WebUI.setText(findTestObject('CURA-OR/COMMENT'), GlobalVariable.varComment)

...
WebUI.selectOptionByLabel(findTestObject('CURA/DROPDOWN'), GlobalVariable.varFacility, false)
...
WebUI.setText(findTestObject('CURA/VISIT-DATE'), GlobalVariable.varVisitDate)

WebUI.setText(findTestObject('CURA/COMMENT'), GlobalVariable.varComment)
